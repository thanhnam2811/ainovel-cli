...
func renderField(label, value string) string {
	...
	return fieldLabelStyle.Render(localizedFieldLabel(label)) + fieldValueStyle.Render(value) + "\n"
}

func renderHighlightField(label, value string) string {
	return fieldLabelStyle.Render(localizedFieldLabel(label)) + highlightValueStyle.Render(value) + "\n"
}
